...
- (BOOL)isConsideredEmpty
{
    ...
    RKLogTrace(@"Determined isConsideredEmpty = %@. self.rowCount = %lu with %lu nonRowItems in the table", isEmpty ? @"YES" : @"NO", (unsigned long)self.rowCount, (unsigned long)nonRowItemsCount);
    return isEmpty;
}
